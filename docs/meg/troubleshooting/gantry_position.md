...
**<span style="color:blue">Power cycle the gantry lifting motor.</span>**
...
<align=full>
If the gantry position **is still undetected**, **<span style="color:red">MEG Support only!</span>** to **power down then restart the electronics**.
