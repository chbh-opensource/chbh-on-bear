...
![RAP](../../images/meg/RAP.jpg){width=40% align=right}
...
10. If there is some data to be saved, you will first see a dialog to confirm that you would really like to proceed. Thereafter, a standard ***megacq*** saving dialog will appear. Note that the rescued data will be saved under the project directory called **unknown** if the real project name could not be retrieved.<br />
