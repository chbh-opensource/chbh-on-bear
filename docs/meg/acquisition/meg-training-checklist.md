...
### **<span style="color:blue">MEG Basics</span>**

**MEG Sensors / MSR**

- The **[Basic Workings](../hardware/meg.md)** of the MEG are explained (the type of sensor, the MSR, Helium cooling to ensure superconductivity).
- MEG Operators are told what not to bring into the **[MSR](../hardware/safety.md)** and the reasons why.
...
- MEG Operators are shown how to **[open the MSR door](../hardware/msr.md)** in an emergency. 

**Helium recycling system**

- The **[Helium Recycling System](../hardware/ihr.md)** is discussed and MEG operators are shown where the IHR system is located.
...
### **<span style="color:blue">MSR Equipment</span>**
...
- MEG Operators are shown how to use the EyeLink PC, how to **[Position/Use](../acquisition/eyelink_operations_guide.md)**
 the FO Camera Head and how to **[use/charge the EyeLink batteries](../acquisition/charging_eyelink_batteries.md)**.
...
### **<span style="color:blue">Before the Participant arrives</span>**
...
### **<span style="color:blue">Preparing the Participant</span>**
...
- MEG Operators are reminded to always make participants feel comfortable, to be polite & courteous at all times, to check whether the participant is feeling OK, paying attention (via the Monitoring System) for symptoms of claustrophobia (e.g. sweating, nervous behavior).<br /> 
To ask, at any time, if they need to take a break/would like or a drink of water. Water, in plastic bottles, is available.

### **<span style="color:blue">Acquisition of Data</span>**
...
- MEG Operators are informed as to why HPI coils are required, shown **[how to attach HPI coils](../acquisition/meg-acquisition-checklist.md/#attach-hpi-coils)**, and how to use the **Polhemus** to perform a HPI digitisation.
	 - The Phantom (''Phantom Phyllis'') can be used to try out/practice digitisations on).
- MEG Operators are shown **[where/how to attach EOG, ECG electrodes](../acquisition/meg-acquisition-checklist.md/#attach-bio-electrodes)**, and the types of electrodes that are available for use.
- MEG Operators are shown the location of the EEG caps and informed **[how to position](../acquisition/position_usage_eeg_caps.md)** them, and **[how to use](../acquisition/eeg_meg.md)** them with MEG, 
and to **[check electrode impedances](../acquisition/position_usage_eeg_caps.md/#check-impedances)**
- MEG Operators are shown how to use the Tuner software to check sensor noise levels, and how to **[resolve noisy channels](../acquisition/noisy_channels.md)**.
...
### **<span style="color:blue">Copying Data</span>**

- MEG Operators are informed they need their own **[RDS Project Space & Linux account](../acquisition/copying_meg_data.md/#requesting-rds-activating-a-linux-account)** 
to copy off acquired data, and are shown **[how to copy off acquired data](../acquisition/copying_meg_data.md/#transferring-acquired-data-to-rds)** to RDS from the Console.

### **<span style="color:blue">Hygiene, Tidying up</span>**
...
- MEG Operators are shown **[how to clean EEG caps](../acquisition/cleaning_eeg_caps.md)**, and **[how to clean reusable electrodes](../acquisition/tidying_up.md/#clean-resuable-electrodes)**
- MEG Operators are informed how and why to **[tidy up](../acquisition/tidying_up.md)** (*e.g. all equipment is shared*).
