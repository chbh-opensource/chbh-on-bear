...
**[User Manual April 2017](https://canvas.bham.ac.uk/courses/81128/files/folder/MEG?preview=21940764)**
- **<span style="color:maroon">Section 7.2 Phantom, page 88.</span>**

**[Data Acquisition v6.0](https://canvas.bham.ac.uk/courses/81128/files/folder/MEG?preview=21940766)**
- **<span style="color:maroon">Section 9.0, Phantom Measurement, page 49.</span>**
<br /><br /><br />

<align=full>
Running the ***Autophantom*** script on the **acquired .fif file** produces a **[Report](https://canvas.bham.ac.uk/courses/81128/files/folder/MEG?preview=22131577)** detailing 2 results, based on dipoles that are checked to be "**OK"** ...
