...
!!! note
    Example contributed by [Romy Froemer](https://github.com/froemero).
...
if expParams.isEEGsession
    ...
    if expParams.isEEGsession
        ...
        try
            ...
            expParams.EEGpars.trigs.stimCode = 10;      % a task relevant stimulus comes on - Choice (all items after first; note that this was fucked up in pilot - triggers were to close to one another)
        ...
        try
            ...
            % io64(expParams.EEGpars.ioObj,expParams.EEGpars.address,0); % @Brown
