...
- [![image for MRI](./images/mri/prisma.jpg)](mri/index.md){ loading=lazy }
- [![image for MEG](./images/meg/TRIUX.jpg)](meg/index.md){ loading=lazy }
- [![image for EEG](https://dummyimage.com/600x400/)](eeg/index.md){ loading=lazy }
- [![image for EEG-fMRI](https://dummyimage.com/600x400/)](eeg-fmri/index.md){ loading=lazy }
- [![image for sleep](https://dummyimage.com/600x400/)](sleep/index.md){ loading=lazy }
- [![image for fNIRS](https://dummyimage.com/600x400/)](fnirs/index.md){ loading=lazy }
- [![image for behaviour](https://dummyimage.com/600x400/)](behaviour/index.md){ loading=lazy }
- [![image for brainstim](https://dummyimage.com/600x400/)](brainstim/index.md){ loading=lazy }
